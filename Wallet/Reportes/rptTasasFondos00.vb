...
Public Class rptTasasFondos00
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Wallet.rptTasasFondos00.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTasasFondos00
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTasasFondos00 = New rptTasasFondos00()
        rpt.Site = Me.Site
        Return rpt
    End Function
