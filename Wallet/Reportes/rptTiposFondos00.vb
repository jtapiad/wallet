...
Public Class rptTiposFondos00
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Wallet.rptTiposFondos00.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTiposFondos00
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTiposFondos00 = New rptTiposFondos00()
        rpt.Site = Me.Site
        Return rpt
    End Function
