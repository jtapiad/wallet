...
Public Class rptCustodias00
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Wallet.rptCustodias00.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustodias00
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustodias00 = New rptCustodias00()
        rpt.Site = Me.Site
        Return rpt
    End Function
