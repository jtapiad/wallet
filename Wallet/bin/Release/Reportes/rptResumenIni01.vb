...
Public Class rptResumenIni01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Wallet.rptResumenIni01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumenIni01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumenIni01 = New rptResumenIni01()
        rpt.Site = Me.Site
        Return rpt
    End Function
