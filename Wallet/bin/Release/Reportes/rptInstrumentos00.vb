...
Public Class rptInstrumentos00
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Wallet.rptInstrumentos00.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInstrumentos00
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInstrumentos00 = New rptInstrumentos00()
        rpt.Site = Me.Site
        Return rpt
    End Function
