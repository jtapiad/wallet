...
Public Class rptEntidades00
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Wallet.rptEntidades00.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEntidades00
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEntidades00 = New rptEntidades00()
        rpt.Site = Me.Site
        Return rpt
    End Function
