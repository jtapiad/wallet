...
Public Class rptRecaudacion01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Wallet.rptRecaudacion01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRecaudacion01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRecaudacion01 = New rptRecaudacion01()
        rpt.Site = Me.Site
        Return rpt
    End Function
