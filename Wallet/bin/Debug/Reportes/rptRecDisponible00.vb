...
Public Class rptRecDisponible00
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Wallet.rptRecDisponible00.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRecDisponible00
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRecDisponible00 = New rptRecDisponible00()
        rpt.Site = Me.Site
        Return rpt
    End Function
