...
Public Class rptTasasBancos00
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Wallet.rptTasasBancos00.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTasasBancos00
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTasasBancos00 = New rptTasasBancos00()
        rpt.Site = Me.Site
        Return rpt
    End Function
